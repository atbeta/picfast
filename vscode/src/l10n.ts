...
const EN_FALLBACK: Record<string, string> = {
  ...
  "picfast.ui.codeLens.title": "$(cloud-upload) Upload to PicFast",
  ...
  "picfast.ui.welcomeNotification":
    'PicFast is active. Open a markdown file — use the "Upload to PicFast" link above each local image reference, or run "PicFast: Upload and Replace Local Image References" from the Command Palette (Ctrl+Alt+U / Cmd+Alt+U). Tip: rebind keys via Ctrl+K Ctrl+S.',
