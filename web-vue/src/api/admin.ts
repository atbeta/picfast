...
export function adminUpdateGroup(
	id: number,
	data: Partial<Pick<AdminGroup, 'name' | 'is_default' | 'is_guest'>> & { configs?: object },
) {
...
export function adminUpdateStrategy(
	id: number,
	data: Partial<Pick<AdminStrategy, 'name' | 'strategy_type'>> & { configs?: object },
) {
